...
namespace Microsoft.DotNet.Workloads.Workload.Install
{
    ...
    {
        private readonly bool _fromCacheOption;
            ...
            : base(parseResult)
        {
            ...
            _fromCacheOption = parseResult.ValueForOption<bool>(WorkloadInstallCommandParser.FromCacheOption);
        }
        ...
        public override int Execute()
        {
            ...
            if (!_printDownloadLinkOnly && !_fromCacheOption)
            {
            ...
            {
                Reporter.Output.WriteLine("Only support \"mobile-ios\", \"mobile-android\", \"mobile\" in the mock");
            }
