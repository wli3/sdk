...
{
    public class GivenThatWeWantToPackAToolProjectWithTestProject : SdkTest
    {
        public GivenThatWeWantToPackAToolProjectWithTestProject(ITestOutputHelper log) : base(log)
        {
        }
